...
<head>
    ...
    <title>404 — Not Found | {{ config('cyra.brand', 'CyraAgroLink') }}</title>
    <style>
        ...
        * { box-sizing: border-box; }
        body { margin:0; min-height:100vh; display:grid; place-items:center; font-family:"Plus Jakarta Sans",system-ui,sans-serif;
            background: radial-gradient(circle at 80% 10%, #134a38, var(--forest) 55%, #06241a); color:#fff; padding:1.5rem; }
