...
@php
    $items = [
        ...
        ['id' => 'destinations', 'label' => 'Destinations', 'href' => '#destinations', 'icon' => 'globe'],
        ['id' => 'process', 'label' => 'Process', 'href' => '#process', 'icon' => 'steps'],
        ['id' => 'orders', 'label' => 'Orders', 'href' => '#orders', 'icon' => 'box'],
        ['id' => 'logistics', 'label' => 'Logistics', 'href' => route('logistics.index'), 'icon' => 'truck'],
...
<aside class="flex w-14 shrink-0 flex-col items-center gap-2 bg-gradient-to-b from-cyra-forest to-[#0A5C2E] py-4 sm:w-16" aria-label="Export hub navigation">
    ...
    @foreach ($items as $item)
        ...
        >
            ...
            @elseif ($item['icon'] === 'globe')
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 21a9 9 0 100-18 9 9 0 000 18zM3 12h18M12 3c2.5 3 2.5 15 0 18M12 3c-2.5 3-2.5 15 0 18"/></svg>
            @elseif ($item['icon'] === 'steps')
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 6h11M9 12h11M9 18h11M5 6h.01M5 12h.01M5 18h.01"/></svg>
