...
@php
    $items = [
        ...
        ['id' => 'loans', 'label' => 'Loans', 'href' => '#loans', 'icon' => 'loan'],
        ['id' => 'savings', 'label' => 'Savings', 'href' => '#savings', 'icon' => 'savings'],
        ['id' => 'vote', 'label' => 'Votes', 'href' => '#vote', 'icon' => 'vote'],
        ['id' => 'equipment', 'label' => 'Equipment', 'href' => route('equipment.marketplace'), 'icon' => 'equipment'],
...
<aside class="flex w-14 shrink-0 flex-col items-center gap-2 bg-gradient-to-b from-cyra-forest to-[#0A5C2E] py-4 sm:w-16" aria-label="Cooperative navigation">
    ...
    @foreach ($items as $item)
        ...
        >
            ...
            @elseif ($item['icon'] === 'loan')
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8c-2.5 0-4 1.2-4 3s1.5 3 4 3 4 1.2 4 3-1.5 3-4 3m0-12V4m0 16v-2M4 10h2m12 0h2M4 14h2m12 0h2"/></svg>
            @elseif ($item['icon'] === 'savings')
            ...
            @elseif ($item['icon'] === 'vote')
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 12l2 2 4-4M7 4h10l1 4H6l1-4zm-1 4h12v12a1 1 0 01-1 1H7a1 1 0 01-1-1V8z"/></svg>
            @elseif ($item['icon'] === 'equipment')
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 17h16M6 17V9l3 2 3-4 3 3 3-2v9M8 21h8"/></svg>
